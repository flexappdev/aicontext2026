...
export const sections: CheatSection[] = [
  ...
  { id: 'top100', title: 'Top 100 AI', group: 'AI Reference', mdPath: '/ai/top100.md' },
  { id: 'ai-history', title: 'AI History', group: 'AI Reference', mdPath: '/ai/ai-history.md' },
  { id: 'ai-models-ref', title: 'AI Models', group: 'AI Reference', mdPath: '/ai/ai-models-ref.md' },
  { id: 'ai-people', title: 'AI People', group: 'AI Reference', mdPath: '/ai/ai-people.md' },
  { id: 'ai-future', title: 'AI Future', group: 'AI Reference', mdPath: '/ai/ai-future.md' },
  ...
  { id: 'notebooklm', title: 'NotebookLM', group: 'Workflows & Infra', mdPath: '/ai/notebooklm.md' },
  { id: 'ollama', title: 'Ollama', group: 'Workflows & Infra', mdPath: '/ai/ollama.md' },
  { id: 'tailscale', title: 'Tailscale', group: 'Workflows & Infra', mdPath: '/ai/tailscale.md' },
